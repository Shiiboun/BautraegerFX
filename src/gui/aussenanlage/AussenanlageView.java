 ...
 * den Außenanlagevarianten bereitstellt.
 */
public class AussenanlageView extends BasisView{
	...
	//9.2 Vorbereitung für elektrische Antriebe Markise EG
    private Label lbl92    	     
	...
	//9.3 Vorbereitung für elektrische Antriebe Markise DG
    private Label lbl93    	     
	...
	//9.6 Elektrischen Antrieb für das Garagentor
    private Label lbl96    	     
	...
	//9.7 Sektionaltor anstatt Schwingtor für die Garage
    private Label lbl97    	     
    ...
    /**
     * erzeugt ein AußenanlageView-Objekt, belegt das zugehoerige Control
