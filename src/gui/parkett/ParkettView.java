...
public class ParkettView extends BasisView {
	...
	// 8.2 Landhausdielen massiv im Küchenbereich des EG
	private Label lbl82 = new Label("Landhausdielen massiv im Küchenbereich des EG");
	private TextField txt82 = new TextField();
	private Label lbl82euro = new Label("Euro");
	private CheckBox chckBx82 = new CheckBox();
	// 8.3 Stäbchenparkett im Essbereich des EG
	private Label lbl83 = new Label("Stäbchenparkett im Essbereich des EG");
	private TextField txt83 = new TextField();
	private Label lbl83euro = new Label("Euro");
	private CheckBox chckBx83 = new CheckBox();
	// 8.4 Stäbchenparkett im Küchenbereich des EG
	private Label lbl84 = new Label("Stäbchenparkett im Küchenbereich des EG");
	...
	// 8.6 Stäbchenparkett im OG
	private Label lbl86 = new Label("Stäbchenparkett im OG");
	...
	// 8.9 Stäbchenparkett im DG komplett im DG
	private Label lbl89 = new Label("Stäbchenparkett im DG komplett im DG");
	private TextField txt89 = new TextField();
	private Label lbl89euro = new Label("Euro");
	private CheckBox chckBx89 = new CheckBox();
	// 8.10 Stäbchenparkett ohne Badbereich im DG
	private Label lbl810 = new Label("Stäbchenparkett ohne Badbereich im DG");
