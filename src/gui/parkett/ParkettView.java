...
public class ParkettView extends BasisView{
    ...
    private Label lbl82    	     
        = new Label("Landhausdielen massiv im Küchenbereich des EG");
    ...
    private Label lbl83    	     
        = new Label("Stäbchenparkett im Essbereich des EG");
    ...
    private Label lbl84    	     
        = new Label("Stäbchenparkett im Küchenbereich des EG");
    ...
    private Label lbl86    	     
        = new Label("Stäbchenparkett im OG");
    ...
    private Label lbl89    	     
        = new Label("Stäbchenparkett im DG komplett im DG");
    ...
    private Label lbl810    	     
        = new Label("Stäbchenparkett ohne Badbereich im DG");
